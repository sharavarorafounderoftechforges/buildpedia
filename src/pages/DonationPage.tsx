...
const DonationPage = () => (
  <div className="buildpedia-container py-16 max-w-2xl mx-auto text-center">
    ...
    <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
      Buildpedia is a community-driven encyclopedia for founders. Your support helps keep it running and growing.
    </p>
    ...
    <div className="border border-border rounded-lg p-6 bg-card">
      ...
      <p className="text-muted-foreground text-sm mb-4">
        Want a professionally written founder page? Reach out to our editorial team.
      </p>
      <Button variant="outline" asChild className="gap-2">
        <a href="mailto:author.buildpedia@gmail.com">
          Contact: author.buildpedia@gmail.com
        </a>
      </Button>
    </div>
  </div>
